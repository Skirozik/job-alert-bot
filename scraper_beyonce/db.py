...
Fork of scraper/db.py for the Beyonce persona — same generic dedup/run-lock
logic, isolated to Beyonce's own Supabase project (separate SUPABASE_URL /
    ...
    if _client is None:
        if not SUPABASE_URL or not SUPABASE_SERVICE_KEY:
            raise RuntimeError(
                ...
                "Copy .env.beyonce.example to .env.beyonce and fill in your values."
            )

...
Fork of scraper/salary_extraction.py — fully generic, no persona-specific
logic, copied verbatim. Used by classifier.py as a deterministic fallback
when the LLM's own salary extraction comes back empty.
"""

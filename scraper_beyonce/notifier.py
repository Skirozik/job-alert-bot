...
Fork of scraper/notifier.py — copied verbatim. The `suggested_resume` line
is already conditional on the field being present, so it degrades
gracefully now that this persona's classifier never sets it.
"""
